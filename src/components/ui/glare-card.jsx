...
export const GlareCard = ({
  ...
  const backgroundStyle = {
    "--step": "5%",
    "--foil-svg": `url("data:image/svg+xml,%3Csvg width='26' height='26' viewBox='0 0 26 26' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath stroke='white' stroke-width='5' stroke-miterlimit='3.86874' stroke-linecap='round' style='mix-blend-mode:darken'/%3E%3C/svg%3E")`,
    ...
    (<div
      ...
      <div
        ...
        <div
          ...
          <div className={cn("h-full w-full bg-indigo-950", className)}>
            {children}
          </div>
        </div>
        <div
